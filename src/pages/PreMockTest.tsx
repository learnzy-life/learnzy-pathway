import { AlertTriangle, Book, Clock3 } from 'lucide-react'
...
const PreMockTest: React.FC = () => {
  ...
  React.useEffect(() => {
    if (!isLoading && !user) {
      ...
      navigate('/auth', {
        state: { from: `/pre-mock-test/${cycle}/${testNumber}` },
      })
    }
        ...
        <div className="max-w-2xl mx-auto mt-12">
          <div className="mb-8 text-center">
            ...
            <p className="text-muted-foreground">
              You are about to start Cycle {cycle} - Mock Test {testNumber}.
              This test contains 180 questions and takes approximately 180
              minutes to complete.
            </p>
          </div>
              ...
              <div className="flex">
                ...
                <div>
                  ...
                  <p className="text-amber-700 text-sm">
                    Once you start the test, the timer will begin. You can't
                    pause the test, but you can navigate between questions
                    freely. Make sure you have a stable internet connection.
                  </p>
                </div>
              </div>
            </div>

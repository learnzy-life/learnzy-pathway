    ...
    <section className="py-10 md:py-16 relative px-3 sm:px-0">
      ...
      <div className="text-center mb-8 md:mb-16">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto mt-3 px-2 sm:px-0">
          We believe that you learn best when your mind is relaxed. Our simple
          approach makes sure you're mentally ready before testing what you
          know.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10 mb-10 md:mb-12">
        <div className="card-glass p-5 md:p-8 card-hover">
          ...
          <p className="text-muted-foreground mb-3 md:mb-4 text-sm md:text-base">
            Before every test, we help you calm your mind with simple activities
            to reduce worry and improve focus.
          </p>
        ...
        <div className="card-glass p-5 md:p-8 card-hover">
          ...
          <p className="text-muted-foreground mb-3 md:mb-4 text-sm md:text-base">
            Our tests check both what you know and how you think to give you
            better insights.
          </p>
          <ul className="space-y-2 mb-4 md:mb-6 text-sm md:text-base">
            <li className="flex items-start">

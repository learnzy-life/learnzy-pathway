        ...
        const enhancedQuestions = sortedQuestions.map(q => {
          if (subject === 'biology') {
            ...
            return {
              ...
              Chapter_name: q.chapter_name || q.Chapter_name || 'Unknown Chapter',
              ...
              Bloom_Taxonomy: q.bloom_taxonomy || q.Bloom_Taxonomy || 'Knowledge',
              Priority_Level: q.priority_level || q.Priority_Level || 'Medium',
              Time_to_Solve: q.time_to_solve || q.Time_to_Solve || 1.0,
              Key_Concept_Tested: q.key_concept_tested || q.Key_Concept_Tested || 'General Knowledge',

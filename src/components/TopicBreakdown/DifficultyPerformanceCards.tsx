...
import { DifficultyPerformance } from '../../utils/analytics/types';

interface DifficultyPerformanceCardsProps {
  difficultyPerformance: DifficultyPerformance;
}

const DifficultyPerformanceCards: React.FC<DifficultyPerformanceCardsProps> = ({ 
...
export default DifficultyPerformanceCards;

...
const DynamicTestGeneratingState = ({
  progress,
}: DynamicTestGeneratingStateProps) => {
  return (
    <div className="max-w-xl mx-auto mt-12 text-center">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          We're analyzing your weak areas from previous tests and creating a
          personalized test just for you.
        </p>
      </div>
